...
exports.customerRecords = exports.callRecords = void 0;
exports.callRecords = [
    {
        name: "Jane Doe",
...
exports.customerRecords = [
    ...
    },
    {
        ...
        chatGPTSummary: "<ul><li>The call was about Car deal.</li><li>The most important part of the call was customer was looking into Honda cars.</li> <li>The speakers in the conversation were Jane Doe and Gus Dakas<//li><ul>",
        fromName: "Gus Dakas",
        toName: "Jane Doe",
        department: "Sales",
...
module.exports = {
    callRecords: exports.callRecords,
    customerRecords: exports.customerRecords,
};
